...
public final class YiSMCore {
    ...
    public YiSMCore initForCipher(boolean forEncryption, YiCryptoKey cryptoKey) throws YiCryptoException {
    ...
    public YiSMCore initForSigner(boolean forSigning, YiCryptoKey cryptoKey) throws YiCryptoException {
