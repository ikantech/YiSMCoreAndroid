...
public class YiCryptoKey {
     ...
     */
    public void initSymmetricKey(byte[] keyBytes, byte[] ivBytes) throws YiCryptoException {
     ...
     * @throws YiCryptoException 密钥非法时抛出
     */
    public void initSM2PrivateKey(byte[] keyBytes) throws YiCryptoException {
     ...
     * @throws YiCryptoException 密钥非法时抛出
     */
    public void initSM2PublicKey(byte[] keyBytes) throws YiCryptoException {
    ...
    public void initRSAPublicKeyFromRaw(byte[] nBytes, byte[] eBytes) throws YiCryptoException {
    ...
    public void initRSAPrivateKeyFromRaw(byte[] nBytes, byte[] eBytes, byte[] dBytes,
    ...
    public void initRSAKeyFromPEM(String pemStr) throws YiCryptoException {
...
//            YiCryptoKey cryptoKey = new YiCryptoKey();
//            cryptoKey.initRSAPrivateKeyFromRaw(
