...
public class RSACipherTest {
    ...
    public void testCreatePubKeyFromPKCS1() {
        try {
            ...
            cryptoKey.initRSAKeyFromPEM(pkcs1PubKStr);
    ...
    public void testCreatePubKeyFromPKCS8() {
        try {
            YiCryptoKey cryptoKey = new YiCryptoKey();
            cryptoKey.initRSAKeyFromPEM(pkcs8PubKStr);
    ...
    public void testCreatePrivateKeyFromPKCS1() {
        try {
            YiCryptoKey cryptoKey = new YiCryptoKey();
            cryptoKey.initRSAKeyFromPEM(pkcs1PrivKStr);
    ...
    public void testCreatePrivateKeyFromPKCS8() {
        try {
            YiCryptoKey cryptoKey = new YiCryptoKey();
            cryptoKey.initRSAKeyFromPEM(pkcs8PrivKStr);
    ...
    public void testCreatePublicKeyFromRaw() {
        try {
            YiCryptoKey cryptoKey = new YiCryptoKey();
            cryptoKey.initRSAPublicKeyFromRaw(YiSMCore.fromHexString(nStr),
    ...
    public void testCreatePrivateKeyFromRaw() {
        try {
            YiCryptoKey cryptoKey = new YiCryptoKey();
            cryptoKey.initRSAPrivateKeyFromRaw(YiSMCore.fromHexString(nStr),
    ...
    public void testCreateCipher2048() {
        try {
            ...
            YiCryptoKey privKey = new YiCryptoKey();
            privKey.initRSAKeyFromPEM(cryptoKey.getRSAPrivateKeyToPem(true));

            YiCryptoKey pubKey = new YiCryptoKey();
            pubKey.initRSAKeyFromPEM(cryptoKey.getRSAPublicKeyToPem(true));
